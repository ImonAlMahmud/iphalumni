      ...
      <div class="flex items-center justify-between pb-3 border-b border-white/10">
        ...
        <div class="flex items-center gap-2" title="Official Smart Membership Pass">
          ...
          <svg class="w-10 h-7 drop-shadow" viewBox="0 0 44 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect x="0.5" y="0.5" width="43" height="31" rx="5" fill="url(#chip-gold-admin)" stroke="#D4AF37" stroke-width="0.8"/>
            ...
            <defs>
              <linearGradient id="chip-gold-admin" x1="0" y1="0" x2="44" y2="32" gradientUnits="userSpaceOnUse">
